...
class Hand extends SkinnedMesh {
  static setupAnimations() {
    ...
    const middleTimes = Array.from({ length: 3 }, (v, i) => (
      new Float32Array([
        0,
        1 - 0.2 * i,
      ])
    ...
    Hand.animations = [
      new AnimationClip('thumb', 1, Array.from({ length: 3 },(v, i) => (
      ...
      new AnimationClip('index', 1, Array.from({ length: 3 }, (v, i) => (
        new QuaternionKeyframeTrack(
      ...
      new AnimationClip('middle', 1, Array.from({ length: 9 }, (v, i) => (
        new QuaternionKeyframeTrack(
  ...
  static setupGeometry() {
    ...
    Hand.geometry = mergeVertices(mergeBufferGeometries(geometries));
