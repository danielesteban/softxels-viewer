...
class Input {
    ...
    this.controllers = Array.from({ length: 2 }, (v, i) => {
      ...
      controller.addEventListener('connected', (e) => {
        ...
        this.attachments.forEach((attachment) => {
          if (attachment.handedness === controller.hand.handedness) {
      ...
      controller.addEventListener('disconnected', () => {
        this.attachments.forEach((attachment) => {
          if (attachment.parent === controller) {
  ...
  onAnimationTick(delta) {
    const { buttons, buttonState, controllers, gamepad, keyboard, look, mouse, movement } = this;
    ...
    if (gamepad !== false) {
      ...
      gamepadState = {
        primary: buttons[6] && buttons[6].pressed,
        secondary: buttons[7] && buttons[7].pressed,
        tertiary: false,
